...
def send_message(text):
    bot_id=23395172
    token = '10108227:96dDi1iBLktZQ902V8zAHR0e'
    send_url = 'https://api.potato.im:8443/%s/sendTextMessage' % token
    ...
    xx = requests.post(send_url, data=json.dumps(postdata), headers=headers)
    if 'message_id' in xx.text:
        print('Sended messages to robots, Please check!')
